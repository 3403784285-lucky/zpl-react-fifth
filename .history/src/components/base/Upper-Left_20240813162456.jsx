...
const RealTimeStatistics = () => {
  ...
  return (
    <Card title="实时数据" bordered={false} style={{ height: '100vh', overflow: 'auto' }}>
      ...
      <Row gutter={16} style={{ height: '75%', marginTop: 24 }}>
        <Col style={{ width: '50%' }}>
          <Row>
            <Col style={{ width: '50%' }}>
          ...
          <div ref={tradeAmountRef} style={{ marginTop: 16, height: 'calc(100% - 60px)' }}></div>
        </Col>
        <Col style={{ width: '50%' }}>
          <Row>
            <Col style={{ width: '50%' }}>
          ...
          <div ref={orderCountRef} style={{ marginTop: 16, height: 'calc(100% - 60px)' }}></div>
        </Col>
      </Row>
    </Card>
  );
