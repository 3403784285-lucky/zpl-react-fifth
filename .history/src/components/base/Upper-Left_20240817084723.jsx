      ...
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        <Col span={12}>
          <Card hoverable >
            <Row>
              <Col span={12}>
                <Statistic loading={loading5}  title="交易金额(元)" value={sales} precision={2} />
              </Col>
              <Col span={12}>
                <Statistic
                  title="较昨日"
        ...
        <Col span={12}>
          <Card hoverable >
            <Row>
              <Col span={12}>
                <Statistic loading={loading6}  title="订单数" value={counts} precision={0} />
              </Col>
              <Col span={12}>
                <Statistic
                  title="较昨日"
