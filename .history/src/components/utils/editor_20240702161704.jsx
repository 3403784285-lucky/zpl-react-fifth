...
const IconFont = createFromIconfontCN({
  scriptUrl: [
       '//at.alicdn.com/t/c/font_4248113_jmvign6j0fs.js'
  ],
});
    ...
    return (
      <>
        <div className="upper-frame bg-color-blue flex-center-center shadow" style={{ height: '50px' }}>
          ...
          <IconFont type="icon-chehui" className='m-10 font-size-lg' />
          <IconFont type="icon-quxiaochehui" className='m-10 font-size-lg' />
