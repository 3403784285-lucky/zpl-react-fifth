...
const handleMarkdownChange = (content) => {
  ...
  // 获取所需的样式和脚本
  const { styles, scripts } = transformer.getUsedAssets(content);
...
const Tiptap = () => {
  ...
  return <>
    ...
    />
     <div id="markmap-container" style={{ height: '400px' }} onClick={(e,content) => handleMarkdownChange(e,content)}></div>
