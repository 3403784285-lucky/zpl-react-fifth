...
const IconFont = createFromIconfontCN({
  scriptUrl: [
    '//at.alicdn.com/t/c/font_4248113_jsdq9ag3x3k.js'
  ],
});
  ...
  return <>
    ...
    <BubbleMenu editor={editor}>
      ...
      /> */}
        ...
        <IconFont type="icon-icon-zhaiyao1" className='m-10 font-size-lg' />
        <IconFont type="icon-zhaiyao" onClick={titleClick} className='m-10 font-size-lg' />
