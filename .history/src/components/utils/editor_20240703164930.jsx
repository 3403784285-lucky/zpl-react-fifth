...
const icon = ['text', 'heading1', 'heading2', 'heading3']
...
const Tiptap = () => {
  ...
  const MenuBar = () => {
    ...
    const contentPop = (<>
      <IconFont type="icon-text" onClick={hide} className={editor.isActive('heading', { level: 1 }) ? 'isActive m-10 font-size-lg' : 'm-10 font-size-lg'} />
      <IconFont type="icon-heading1" onClick={hide} className='m-10 font-size-lg' />
      <IconFont type="icon-heading2" onClick={hide} className='m-10 font-size-lg' />
      <IconFont type="icon-heading3" onClick={hide} className='m-10 font-size-lg' />
    </>
