...
const Tiptap = () => {
  ...
  const contentPopCopy = (<>
    <IconFont type="icon-table-add" onClick={} className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
    <IconFont type="icon-table-remove" onClick={} className='m-10 font-size-lg' onClick={() => editor.chain().focus().deleteTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
    <IconFont type="icon-add-column" onClick={} className='m-10 font-size-lg' onClick={() => editor.chain().focus().addColumnAfter().run()} />
    <IconFont type="icon-delete-column" onClick={} className='m-10 font-size-lg' onClick={() => editor.chain().focus().deleteColumn().run()} />
    <IconFont type="icon-add-row" onClick={} className='m-10 font-size-lg' onClick={() => editor.chain().focus().addRowAfter().run()} />
    <IconFont type="icon-delete-row" onClick={} className='m-10 font-size-lg' onClick={()=>editor.chain().focus().deleteRow().run()} />
