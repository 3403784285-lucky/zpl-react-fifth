...
const handleMarkdownChange = () => {
  const content = editor.getHTML(); // 获取编辑器内容，可以根据实际情况使用 editor.getJSON() 或其他方法获取适当的数据格式
...
const Tiptap = () => {
  ...
  return <>
    ...
    />
     ...
     <div id="markmap-container" style={{ height: '400px' ,width:'400px'}} onClick={handleMarkdownChange}></div>
