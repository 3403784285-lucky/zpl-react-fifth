...
const Tiptap = () => {
  ...
  const contentPopThree = (<>
    ...
    const contentPopFour = (<>
      ...
      <IconFont type="icon-double-quotes-left " className={ editor.isActive('bulletList')? `${classes.isActive} m-10 font-size-lg`:'m-10 font-size-lg'} onClick={() => editor.chain().focus().toggleBlockquote().run()} />
