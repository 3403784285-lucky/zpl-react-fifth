...
const contentPop = (<>
  <IconFont type="icon-text" className='m-10 font-size-lg' />
  <IconFont type="icon-heading1" className='m-10 font-size-lg' />
  <IconFont type="icon-heading2" className='m-10 font-size-lg' />
  <IconFont type="icon-heading3" className='m-10 font-size-lg' />
</>
    ...
    return (
      <>
        <div className={`upper-frame bg-color-blue flex-center-center shadow`} style={{ height: '50px' }}>
          ...
          <IconFont onClick={() => editor.chain().focus().toggleCodeBlock().run()} className={editor.isActive('codeBlock') ? 'isActive m-10 font-size-lg' : 'm-10 font-size-lg'}  type="icon-code-inline"/>
          <Popover placement="bottom" content={contentPop}>
          <IconFont type="icon-heading1" className='m-10 font-size-lg' />
          </Popover>
