...
import { Col, ColorPicker, Divider, Row, Space, theme,Select } from 'antd';
...
- 文化和旅游产业是全球经济发展中的重要组成部分
  - 旅游业是一项支柱产业，为国家和地区带来巨大的经济收益
  - 通过吸引游客，旅游业可以刺激消费、增加就业机会以及带动相关产业的繁荣
- 文化旅游不仅可以提供就业机会
  - 通过保护和传承本地的文化遗产，吸引游客到来
  - 可以带动当地的旅游业、餐饮业、酒店业等相关产业的兴盛
  - 为当地居民提供更多的就业机会和收入来源
...
const Tiptap = () => {
  ...
  return <>
    ...
    <div className="footer shadow flex-r-center-center p-x-10" style={{ height: '50px',justifyContent:'space-between' }}>
      <IconFont type='icon-suoding' className='font-size-mlg'></IconFont>
      <Select
      defaultValue={<><IconFont type="icon-suoding"></IconFont></>}
      style={{
        width: 120,
      }}
      allowClear
      options={[
        {
          value: 'person',
          label:<div className='flex-c-center-center'><IconFont type="icon-suoding" className='font-size-vlg'></IconFont></div>,
        },
        {
          value: 'people',
          label:<div className='flex-c-center-center'><IconFont type="icon-gongkai" className='font-size-mlg'></IconFont></div>,
        },
