      ...
      <>
        <div className={`upper-frame bg-color-blue flex-center-center shadow`} style={{ height: '50px' }}>
          <div className='position-absolute' style={{ opacity: 0, left: 192 }}>
            ...
            /></div>
          <IconFont type="icon-undo"  onClick={() => editor.commands().redo()} className='m-10 font-size-lg' />
          <IconFont type="icon-redo"  onClick={() => editor.commands().undo()} className='m-10 font-size-lg' />
