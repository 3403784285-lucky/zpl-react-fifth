...
const IconFont = createFromIconfontCN({
  scriptUrl: [
    '//at.alicdn.com/t/c/font_4248113_voml9zyk5ll.js'
  ],
});
...
const contentPop = (<>
  ...
  <IconFont type="icon-heading-h2" className='m-10 font-size-lg' />
  <IconFont type="icon-heading-h3" className='m-10 font-size-lg' />
</>
