...
const IconFont = createFromIconfontCN({
  scriptUrl: [
    '//at.alicdn.com/t/c/font_4248113_ff23axkg1ev.js'
  ],
});
    ...
    return (
      <>
        <div className="upper-frame bg-color-blue flex-center-center shadow" style={{ height: '50px' }}>
          ...
          <IconFont onClick={() => editor.chain().focus().setColor(colorS).run()}  type="icon-font-color" className='m-10 font-size-lg' style={{color:colorS}}/>
