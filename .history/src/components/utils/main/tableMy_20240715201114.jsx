import { Input, Table, Button, Radio, Menu, Pagination, Popover, Modal, Divider, Select, message, Cascader } from 'antd';
        ...
        const fetchData = async () => {
            ...
            if (res.data) {
                ...
                if (dataContent != 2 && dataContent != 3) {
                    ...
                    res.data = res.data.filter(item => { return item.category == '7天内' })[0].documentInfoVOList;
