...
const RichTextEditor = ({ documentId,toDocument ,setMark}) => {
    ...
    const handleRestoreClick = async () => {
        try {
            ...
            console.log(selectedVersion.documentId, selectedVersion.id+"00000000000")
    ...
    return (
        <Layout style={{ height: '100%', display: 'flex' }}>
            ...
            <Content style={{  width: '100%', height:'100%', overflowY: 'auto' }}>
                ...
                <div style={{ border: '1px solid #ccc', padding: '20px', borderRadius: '5px', backgroundColor: '#fff', width: '100%', height: 'calc(100vh - 48px)', overflowY: 'auto' }}>
