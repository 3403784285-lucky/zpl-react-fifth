...
import { Markmap } from 'react-markmap';
...
const Tiptap = () => {
  const editor = useEditor({
    ...
    content,
    onUpdate: ({ editor }) => {
      const markdownContent = editor.getHTML(); // 获取 Markdown 内容
      const markmapElement = document.getElementById('markmap-container');

      markmap(markmapElement, markdownContent, {
        preset: 'default',
      });
    },
  });
