...
const Tiptap = () => {
  ...
  const selectColorComplete=(colorO)=>{
    console.log("我现在选择的颜色是"+JSON.stringify(color))
    setColor(colorO.metaColor.originalInput)
    ...
    return (
      <>
        <div className="upper-frame bg-color-blue flex-center-center shadow" style={{ height: '50px' }}>
          ...
          <IconFont type="icon-font-color" className='m-10 font-size-lg' style={{color}} />
