    ...
    if (editor && formatToApply) {
      ...
      console.log("哈哈哈"+from,to)
        ...
        formatToApply.forEach(mark => {
          ...
          if(level!=''){
            editor.chain().focus().setTextSelection({from: from, to: to}).toggleHeading({level:level});
          }
          
          editor.chain().focus().setTextSelection({from: from, to: to}).setTextAlign(textAlign);
