...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <BubbleMenu editor={editor}>
      <Modal title="样式表" open={true} footer={null} width={400} >
        <div className='flex-c-center-start'>
          <div className='m-t-20 m-b-20 '>
            <h5 className='m-y-10'>标题</h5>
            <h6 className='m-y-8'>字体</h6>
            <Select
              labelInValue
              defaultValue={{
                value: 'lucy',
          ...
          <div style={{ height: '180px' }}>
            ...
            <div className='p-10 flex'>
              Meters/bonwe 洗涤说明 最高洗涤温度30℃ 常规程序 不可漂白 悬挂晾干 熨斗底板最高温度110°℃ 常规干洗 注意事项： 分开洗涤，不宜长时间漫泡，有 钮扣或拉链的服饰先将钮扣或拉链 扣好，熨烫时采用仅蒸汽熨烫。
            </div>
          </div>
          <div className='flex-r-center-center w-full'>
            <Button className='  b-rd-8 m-r-16' type='primary' >使用</Button>
            <Button className='  b-rd-8 bg-color-grey text-color-white' >取消</Button>
          </div>
