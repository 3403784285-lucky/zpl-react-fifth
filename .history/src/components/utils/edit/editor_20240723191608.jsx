...
import ExportToWordButton from '../main/exportWord.jsx';
...
const Tiptap = ({ user, room, content, editor = {},documentId }) => {
  ...
  const contentFive = (<div >
    <div className='p-6 hover-effect b-rd-6'><ExportToWordButton editor={editor} documentId={documentId} /></div>
