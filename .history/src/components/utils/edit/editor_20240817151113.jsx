...
const Tiptap = ({ setIsModalVisible,content, editor = {}, provider, saveTimeInit }) => {
  ...
  const [visualLoading,setLoading]=useState(false)
...
if (visible) {
  ...
  return (<>{spin ? (<Spin size="large" style={{ margin: '300px 520px' }} />) : (<div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', }} > {!content ? (
     ...
     {visible&& (
        <Draggable>
          <div className="floating-panel p-10 position-absolute bg-color-white shadow" >
            <div className="floating-panel-header">
            </div>
            <div ref={chartRef} style={{width:'300px',height:250}} className="chart-container"></div>
