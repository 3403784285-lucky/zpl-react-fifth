...
import { createFromIconfontCN, ExclamationCircleOutlined,CloudUploadOutlined } from '@ant-design/icons';
...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <Modal title="图片识别结果" open={true} footer={null} width={400} >
            ...
            <Button className=' m-t-30 b-rd-8 m-r-16 m-l-200' type='primary' >使用</Button>
