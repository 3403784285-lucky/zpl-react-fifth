...
const Tiptap = ({ user, room, content ,editor={}}) => {
  ...
  const toggleSize = () => {
    console.log("设置了")
    setIsHalfSize(prevSize => !prevSize);
  };
...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', }} > {!content ? (
      ...
      <div className='position-relative' style={{ width: '25%', backgroundColor: 'red',boxShadow: 'rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px' }}>
      <CaretRightOutlined className='position-absolute font-size-mlg' onClick={toggleSize} style={{left:11,bottom:10}}/>
        <Content className='flex  h-full w-full '>
          <Menu
            ...
            className={`resizable-element flex-c-start-center p-y-20 ${isHalfSize ? 'half-size' : 'full-size'}`}
            onClick={onClickMenu}
          >
          </Menu>
