...
const Tiptap = ({ user, room, content, editor = {} }) => {
  ...
  const renderChart = (data) => {
    const chartContainer = editor.createElement('div', {
      class: 'chart-container',
    });
    editor.chain().focus().insertContent(chartContainer).run(); // const chartContainer = document.querySelector('.chart-container');
    // // 使用Echarts绘制图表
