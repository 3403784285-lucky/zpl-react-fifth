...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', overflowY: 'auto' }} > {spin ? (
      ...
      <div style={{ width: '20%', backgroundColor: 'red' }}>
        <Content className='flex shadow-first h-full'>

          <Menu
            mode="inline"
            items={itemThrees}
            style={{ height: '100%', borderRight: 'rgb(0,103,255) 0.5px solid', width: '10%' }}
            selectedKeys={['1']}
