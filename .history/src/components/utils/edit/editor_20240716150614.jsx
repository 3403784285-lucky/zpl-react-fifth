...
const IconFont = createFromIconfontCN({
  scriptUrl: [
    '//at.alicdn.com/t/c/font_4248113_cppnpj0bagd.js'
  ],
});
...
`,
  ...
  return <>{spin ? <Spin size="large" style={{ margin: '290px 500px' }} />
    : (
      <div style={{ height: '100%' }}>
        ...
        <div className='flex' style={{ height: '84%' }}>
          {!content ? (
            <Spin size="large" style={{ margin: '290px 500px' }} />
          ) : (
            <>
              {/* Your resizable elements */}
