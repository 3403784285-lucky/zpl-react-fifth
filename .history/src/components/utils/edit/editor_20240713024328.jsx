...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <Modal title="结果" open={isModalOpenThree} footer={null} onOk={handleOkThree} onCancel={handleCancelThree} width={400} >
            <div className='m-t-20 m-l-80'>## 综述国内外关于AI在智能编辑器中应用的研究现状
...
概括论文的主要研究议题和整体框架，使读者对论文的组织结构和核心内容有初步了解。</div>
            <Button className=' m-t-30 b-rd-8 m-r-16 m-l-200' type='primary' onClick={handleDeleteConfirm}>替换</Button>
