...
`,
  ...
  const handleApplyStyles = () => {
    ...
    heading1Positions.forEach(({ from, to }) => {
      console.log(fontFamilyH1Value + "!")
      editor.chain().setTextSelection({ from: from, to: to }).setFontFamily(fontFamilyH1Value)
      editor.chain().focus().setLineHeight(lineHeightH1Value).setFontSize(fontSizeH1Value).run();
