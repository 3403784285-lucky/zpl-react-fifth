...
const MenuBar = ({ handleSizeChange,shrink, changeShrink, handleFontChange, editor, selectColorComplete, contentPop, contentPopCopy, contentPopThree, currentIcon, currentTextAlign, colorS, open, handleOpenChange, openCopy, handleOpenChangeCopy, openThree, handleOpenChangeThree, openFour, handleOpenChangeFour, applyLineHeight, handleFormatBrushClick, handleFormatBrushDoubleClick }) => {
  ...
  return (
    <div className={`upper-frame bg-color-blue flex-center-center shadow`} style={{ height: '8%' }}>
      {contextHolder}
      <div className='position-absolute' style={{opacity:0, left: 810 }}>
        <ColorPicker
          defaultValue='grey'
      ...
      className={editor.isActive('hi') ? `${classes.isActive} m-4 p-10 b-rd-4 font-size-lg` : 'm-4 p-10 b-rd-4 font-size-lg'}
