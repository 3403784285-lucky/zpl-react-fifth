  ...
  const createExport = useCallback(format => () => {
    ...
    editor.chain().export({
      ...
      onExport(context) {
        ...
        const updatedContext = { blob, error, download, filename };
        const t3 = URL.createObjectURL(e2), a2 = document.createElement("a");
        a2.href = t3, a2.download = i, a2.click(), window.requestAnimationFrame(() => {
