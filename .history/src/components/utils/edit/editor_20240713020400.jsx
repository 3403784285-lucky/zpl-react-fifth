...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <BubbleMenu editor={editor}>
      <div className='shadow flex-c-center-start p-8' style={{
        background: "white",
        width: '80px',
        height:'200px'
      ...
      /> */}
        ...
        <IconFont type="icon-zhongxiex" onClick={rewriteClick} className=' font-size-lg' />
        <IconFont type="icon-jurassic_chart" onClick={createChartClick} className=' font-size-lg' />
        <IconFont type="icon-neirongshengchengqi" onClick={contentGenerationClick} className='m-10 font-size-lg' />
        <IconFont type="icon-a-nav_AImanagement" onClick={baiduClick} className=' font-size-lg' />
        ...
        >
          ...
          <IconFont type="icon-runse" className={` p-10 font-size-lg ${classes.isActive}`} />
        </Popover>
        {contextHolder}
