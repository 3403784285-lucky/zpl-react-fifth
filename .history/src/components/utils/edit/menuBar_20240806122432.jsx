...
const MenuBar = ({ handleSizeChange, isFormatBrushActive,emptyFormat, fontSize, fontFamily, shrink, changeShrink, handleFontChange, editor, selectColorComplete, contentPop, contentPopCopy, contentPopThree, currentIcon, currentTextAlign, colorS, open, handleOpenChange, openCopy, handleOpenChangeCopy, openThree, handleOpenChangeThree, openFour, handleOpenChangeFour, applyLineHeight, handleFormatBrushClick, handleFormatBrushDoubleClick }) => {
  ...
  return (
    <div className={`upper-frame bg-color-blue flex-end-center shadow p-x-10`} style={{ height: '8%' }}>
      {contextHolder}
      <div className='position-absolute' style={{ opacity: 0, left: 790 }}>
        <ColorPicker
          defaultValue='grey'
      ...
      <div className='flex-r-center-center'>
        <div className='bg-color-success b-rd-10 m-r-30' style={{width:'10px',height:'10px'}}></div>
        <div className='font-size-sm text-color-grey'>两人在线</div>
      </div>
      ...
      <Tooltip placement="bottom" title={"格式刷(用法:选中要复制的格式点击格式刷，显示选中后，再点击要应用的文本点击格式刷即可)"} arrow={mergedArrow}>
