...
`,
  ...
  return (<>{spin ? (<Spin size="large" style={{ margin: '300px 520px' }} />) : (<div style={{ height: '100%' }}>
    ...
    <div className="footer shadow flex-r-center-center p-x-10" style={{ height: '8%', justifyContent: 'space-between' }}>
      <div className="flex"><Tooltip placement="topLeft" title='文档权限'>
        <Select
          value={power}
          style={{
            width: 60,
        ...
        <div className=' text-color-grey font-size-sm'>字数：{editor.storage.characterCount.characters()}</div></div>

      <div className='flex-r-center-center'>
        <div className='text-color-grey m-r-10 font-size-sm'>已保存:12:29:00</div>
        <Popover
          trigger="click"
          open={openFive}
          content={contentFive}
