...
if (visible) {
  ...
  return (<>{spin ? (<Spin size="large" style={{ margin: '300px 520px' }} />) : (<div style={{ height: '100%' }}>
     {visible&& (
        <Draggable>
        <div className="floating-panel p-10 position-absolute bg-color-white shadow flex-c-center-center" style={{top:20}}>
          {visualLoading && <Spin />}
          <div ref={chartRef} style={{ width: '400px', height: 250 }} className="chart-container"></div>
          <div style={{ marginTop: '20px', textAlign: 'center' }}>
            <Button type="primary" onClick={() => console.log('选择使用')} style={{ marginRight: '10px' }}>
              选择使用
            </Button>
