...
if (visible) {
  const selectedText = editor.state.doc.cut(editor.state.selection.from, editor.state.selection.to).textContent;
      ...
      formData.append('image_type', visual);
  ...
  const polishClick = async (value) => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/textBeautification', {
        method: 'POST',
        body: formData,
        headers: {
  ...
  const rewriteClick = async () => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/rewrite', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const correctionClick = async () => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/textErrorCorrection', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const continuationClick = async () => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/textContinuation', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const expansionClick = async () => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/expansion', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const summarizationClick = async () => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/abbreviation', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const translateClick = async () => {
    ...
    try {
      const response = await fetch('https://f504iccf72ke3bha.aistudio-hub.baidu.com/textTranslation', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  return (<>{spin ? (<Spin size="large" style={{ margin: '300px 520px' }} />) : (<div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', }} > {!content ? (
     ...
     {visible? <Spin/>: (
        <Draggable>
          <div className="floating-panel p-10 position-absolute bg-color-white shadow" style={{width:400}}>
        ...
        <Content className='flex  h-full w-full '>
          ...
          <div className="bg-color-white flex-1">
            ...
            {current == 1 ? (<Extraction editor={editor} />) : (current == 2 ? (<Dictionary />) : (current == 3 ? (<Generation />) : (current == 4 ? (<Polishing editor={editor} fontFamilyH1Value={fontFamilyH1Value}
              ...
              setLineHeightH4Value={setLineHeightH4Value} />) : (current == 5 ? (<MyExample editor={editor} />) : (current == 6 ? (<AiHelper />) : (current == 7 ? (<PassageComment editor={editor} />) : (current==8?(<Picture editor={editor}/>):(current==9?<Style  
                handleApplyStyles={handleApplyStyles}
                ...
                setLineHeightH3Value={setLineHeightH3Value}
                lineHeightH4Value={lineHeightH4Value}
                setLineHeightH4Value={setLineHeightH4Value} />:<Hot/>))))))))}
          </div>
        </Content>
      </div>
    </>
