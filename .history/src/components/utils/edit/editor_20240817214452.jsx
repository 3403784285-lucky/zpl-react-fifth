...
if (visible) {
  ...
  const polishClick = async (value) => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/textBeautification', {
        method: 'POST',
        body: formData,
        headers: {
  ...
  const rewriteClick = async () => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/rewrite', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const correctionClick = async () => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/textErrorCorrection', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const continuationClick = async () => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/textContinuation', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const expansionClick = async () => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/expansion', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const summarizationClick = async () => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/abbreviation', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
  ...
  const translateClick = async () => {
    ...
    try {
      const response = await fetch('http://192.168.43.214:5000/textTranslation', {
        method: 'POST',
        body: formData,
        headers: {
          'Authorization': 'your-authorization-token',
