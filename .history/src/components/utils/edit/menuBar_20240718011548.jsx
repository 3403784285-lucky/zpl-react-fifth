...
import { Popover, ColorPicker, Row, Col, Divider, Select, Tooltip } from 'antd'
...
const MenuBar = ({ handleSizeChange, handleFontChange, editor, selectColorComplete, contentPop, contentPopCopy, contentPopThree, currentIcon, currentTextAlign, colorS, open, handleOpenChange, openCopy, handleOpenChangeCopy, openThree, handleOpenChangeThree, openFour, handleOpenChangeFour, applyLineHeight, handleFormatBrushClick, handleFormatBrushDoubleClick }) => {
  ...
  return (
    <div className={`upper-frame bg-color-blue flex-center-center shadow`} style={{ height: '8%' }}>
      ...
      <Tooltip placement="bottom" title={"图像"} arrow={mergedArrow}>
      ...
      <Tooltip placement="bottom" title={"ai只能"} arrow={mergedArrow}>


      <IconFont type="icon-ai" className='m-10 font-size-lg' />
      </Tooltip>
