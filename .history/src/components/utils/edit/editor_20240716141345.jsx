...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', }} > {!content ? (
      ...
      <div className='position-relative' style={{ width: '25%', backgroundColor: 'red', border:'blue 0.1px solid' }}>
      <CaretRightOutlined className='position-absolute font-size-mlg' style={{left:11,bottom:10}}/>
        <Content className='flex  h-full w-full'>
          <Menu
            mode="inline"
            items={itemThrees}
            style={{ height: '100%', borderRight:  'rgb(0,103,255) 0.01px solid', width: '15%' }}
