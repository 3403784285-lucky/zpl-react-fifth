...
if (visible) {
  ...
  return (<>{spin ? (<Spin size="large" style={{ margin: '300px 520px' }} />) : (<div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', }} > {!content ? (
     ...
     {visible&& (
        <Draggable>
          <div className="floating-panel p-10 position-absolute bg-color-white shadow" style={{width:400,height:200}}>
            <div className="floating-panel-header">
            </div>
            <div ref={chartRef} style={{width:'100%',height:100%}} className="chart-container"></div>
