      ...
      <div className='shadow-primary flex-c-center-start' style={{
        ...
        <div className='flex-r-center-center m-4 b-rd-6 hover-effect' style={{ justifyContent: 'space-between' }}>
          <Popover
            ...
            content={(
              <div>
                <div className='p-6 hover-effect b-rd-6' onClick={pictureClick}> 饼图</div>
                <div className='p-6 hover-effect b-rd-6' onClick={pictureClick}>柱状图</div>
                <div className='p-6 hover-effect b-rd-6' onClick={pictureClick}>折线图</div>
              </div>
            )}
