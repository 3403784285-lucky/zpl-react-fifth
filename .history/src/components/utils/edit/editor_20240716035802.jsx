...
`,
  ...
  return <div style={{ height: '100%' }}>
    ...
    <div className='flex' style={{ height: '84%', }} > {spin ? (
      ...
      <div className='shadow-primary' style={{ width: '25%', backgroundColor: 'red' }}>
        <Content className='flex shadow-primary h-full w-full'>
          <Menu
            mode="inline"
            items={itemThrees}
    ...
    <div className="footer shadow-primary flex-r-center-center p-x-10" style={{ height: '8%', justifyContent: 'space-between' }}>
