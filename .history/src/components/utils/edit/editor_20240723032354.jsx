...
const Tiptap = ({ user, room, content, editor = {} }) => {
  ...
  const [currentFamily, setCurrentFamily] = useState("Inter")
  const [fontFamily, setFontFamily] = useState("Inter")
  const [currentSize,setCurrentSize] = useState("Inter")
  ...
  useEffect(() => {
    ...
    const handleTransaction = () => {
      ...
      if ($from.sameParent($to)) {
        ...
        const size = marks.find(mark => mark.attrs.fontSize != null);
        ...
        if (family) {
          setFontFamily(size.attrs.fontFamily);
        } else {
...
`,
  ...
  const handleApplyStyles = () => {
    ...
    handleApplyStylesOften(fontSizeH3Value, fontFamilyH3Value, lineHeightH3Value, 3)
