    ...
    <Modal title="图片识别结果" open={true} footer={null} width={400} >
      <div className='flex-c-center-center'>
         <div className='m-t-20'>
            ...
            <div className='flex'><Button className=' m-t-30 b-rd-8 m-r-16' type='primary' >使用</Button>
            <Button className=' m-t-16 b-rd-8 bg-color-grey text-color-white' >取消</Button></div>
