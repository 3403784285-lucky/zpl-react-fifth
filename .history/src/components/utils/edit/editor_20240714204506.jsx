...
const Tiptap = ({ user, room, ydoc, content, editor }) => {
  ...
  return <div style={{ height: '100%' }}>
    ...
    <BubbleMenu editor={editor}>
       ...
       <div className='shadow flex-c-center-start' style={{
        ...
        <div className='flex-r-center-center' onClick={rewriteClick} style={{ justifyContent: 'space-between' }}>
      ...
      <div className='flex-r-center-center' onClick={contentGenerationClick} style={{ justifyContent: 'space-between' }}>
      ...
      <div className='flex-r-center-center' style={{ justifyContent: 'space-between' }}>
        <IconFont type="icon-keshihua"  className='m-10 font-size-lg' />
