...
const Tiptap = () => {
  ...
  const contentPopThree = (<>
    ...
    const contentPopFour = (<>
      <IconFont type="icon-bg-color" className='m-10 font-size-lg' onClick={() => {editor.chain().focus().toggleHighlight({ color: '#8ce99a' }).run();console.log("高亮提示")} } />
      <IconFont type="icon-list-disorder" className='m-10 font-size-lg' onClick={() => editor.chain().focus().setTextAlign('center').run()} />
      <IconFont type="icon-clean" className='m-10 font-size-lg' onClick={() => editor.chain().focus().setTextAlign('right').run()} />
      <IconFont type="icon-double-quotes-left " className='m-10 font-size-lg' onClick={() => editor.chain().focus().setTextAlign('right').run()} />
      ...
      <IconFont type="icon-list-order" className='m-10 font-size-lg' onClick={() => editor.chain().focus().setTextAlign('right').run()} />
