...
const Tiptap = () => {
  ...
  const handleOpenChangeThree = (newOpenCopy) => {
    console.log("表格开关")
    setOpenCopy(newOpenCopy);
  };
  ...
  const contentPopCopy = (<>
    <IconFont type="icon-table-add" onClick={hideCopy} className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
    <IconFont type="icon-table-remove" onClick={hideCopy} className='m-10 font-size-lg' onClick={() => editor.chain().focus().deleteTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
    <IconFont type="icon-add-column" onClick={hideCopy} className='m-10 font-size-lg' onClick={() => editor.chain().focus().addColumnAfter().run()} />
    <IconFont type="icon-delete-column" onClick={hideCopy} className='m-10 font-size-lg' onClick={() => editor.chain().focus().deleteColumn().run()} />
    <IconFont type="icon-add-row" onClick={hideCopy} className='m-10 font-size-lg' onClick={() => editor.chain().focus().addRowAfter().run()} />
    <IconFont type="icon-delete-row" onClick={hideCopy} className='m-10 font-size-lg' onClick={()=>editor.chain().focus().deleteRow().run()} />
  ...
  const contentPopThree = (<>
    ...
    <IconFont type="icon-table-remove" className='m-10 font-size-lg' onClick={() => editor.chain().focus().deleteTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
