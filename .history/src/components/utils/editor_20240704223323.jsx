...
const Tiptap = () => {
  ...
  const handleOpenChangeCopy = (newOpen) => {
    setOpen(newOpen);
  };
      ...
      <>
        <div className={`upper-frame bg-color-blue flex-center-center shadow`} style={{ height: '50px' }}>
          ...
          <Popover
           ...
           <IconFont type="icon-add-column" className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
           <IconFont type="icon-delete-column" className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
           <IconFont type="icon-add-row" className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
           <IconFont type="icon-delete-row" className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
          ...
          >
           <IconFont type="icon-table" className='m-10 font-size-lg' onClick={() => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} />
          </Popover>
