...
function Center() {
    return <div className="frame ">
        <div className="flex-r-start-center" style={{ justifyContent: 'space-between', backgroundImage: "url('/img/module-back.png')", height: '400px' }}>
            ...
            <div className="frame mosh shadow m-r-50 p-30 text-color-second flex-c-center-center" style={{ width: '400px', height: '230px' }}>
                ...
                <div className="two flex-r-center-center" style={{justifyContent:'space-between'}}>
                    <div className="number-one m-x-10">
                        <div className="number">0</div>
                        <div className="desc">云烛币</div>

                    </div>
                    
                    <div className="number-two p-x-10">
                    <div className="number">0</div>
                        <div className="desc">下载特权</div>
                    </div>
                    <div className="number-three p-x-10">
                    <div className="number">0</div>
                        <div className="desc">优惠卷</div>
                    </div>

                </div>
                <div className="three"><Button className="b-rd-4 font-bold" type="primary">限时2.9开通VIP</Button></div>
                <div className="four text-color-vip">会员享6亿+优质内容免费下载</div>
