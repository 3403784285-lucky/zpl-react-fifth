...
function Recommendation() {
    ...
    <div
      key={index}
      className="item b-rd-6 shadow p-10 m-10 flex-c-center-center"
      style={{ width: '32%', height: '200px' }}
    >
      {item.type === '文本' ? (
        <div
          className="text-content m-b-10 font-size-sm"
          style={{
            width: '90%',
            height: '76%',
            overflow: 'hidden',
      ...
      <div className="title font-bold text-overflow-1" style={{ width: '50%' }}>
