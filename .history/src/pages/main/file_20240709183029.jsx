...
function File() {
    ...
    return <div className="h-full p-10" >
        ...
        <Pagination className='m-t-20 position-absolute' style={{ bottom: 40, left: 500 }} defaultCurrent={1} pageSize={5} total={500} showSizeChanger showQuickJumper hideOnSinglePage={true} />
