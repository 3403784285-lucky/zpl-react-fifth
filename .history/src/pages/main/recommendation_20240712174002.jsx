    ...
    return <div className="p-36" style={{ height: '80.5vh', overflowY: "auto" }}>
        ...
        <div className="video m-b-20">
            ...
            <Modal title={
                ...
                <div>
                    {file.userId?{file.type=="图片"?<div style={{height:'100%',overflowY:'auto'}}>{loadingContent}</div>:<img style={{width:'100%'}}></img>:<EditorContentCopy loadingContent={loadingContent}/>} 
                </div>
