...
function Recommendation()
{
    return <div className="p-10">
        ...
        <div className="first-content">
            <div className="item-frame p-30" >
                <div className="item b-rd-6 shadow p-10 flex-c-center-center" style={{width:'28%'}}>
                    ...
                    <div className="pres font-size-sm text-color-grey text-overflow-1">12:20</div>
                </div>
