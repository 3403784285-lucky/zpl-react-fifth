...
const IconFont = createFromIconfontCN({
    scriptUrl: [
        '//at.alicdn.com/t/c/font_4248113_2dvrk3e54c8.js',
        ...
        <div className="favorite-frame p-20 p-b-2 ">
            ...
            <div className="list-frame p-16 flex" style={{justifyContent:'space-between'}}>
                <div className="li shadow b-rd-6 p-16 m-10 m-r-16" style={{ width: '250px', height: '180px' }}>
                    <div className="first-header flex-r-start-center"><IconFont className='font-size-vlg m-r-10' type="icon-wenjianjia" />读书笔记<IconFont className='m-r-20' onClick={changePower} type="icon-suoding" /></div>
