...
function Recommendation() {
    return <div className="p-30" style={{ height: '80.5vh', overflowY: "auto" }}>

    <div className="flex" style={{justifyContent:'space-between'}}>
    <div className="one  b-rd-10" style={{width:'30%',height:'120px',backgroundImage:"url('/img/rec-one.png')",backgroundSize:'cover'}}></div>
    <div className="one  b-rd-10" style={{width:'30%',height:'120px',backgroundImage:"url('/img/rec-two.png')",backgroundSize:'cover'}}></div>
    <div className="one  b-rd-10" style={{width:'30%',height:'120px',backgroundImage:"url('/img/rec-three.png')",backgroundSize:'cover'}}></div>
