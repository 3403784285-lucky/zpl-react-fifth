...
import { Tag, Card, Modal, Button,Skeleton } from 'antd'
...
function Recommendation() {
    ...
    const [loadingAuthor,setLoadingAuuthor]=useState('')
        ...
        <div className="video m-b-20">
            ...
            <Modal title={
                ...
                <div className='flex-r-end-center'>
                    <Button className="m-r-20" bordered>添加模板</Button>
