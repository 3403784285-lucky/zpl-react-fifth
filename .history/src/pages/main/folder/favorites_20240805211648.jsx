...
function Favorites() {
    ...
    const handleOkThree = () => {
        const res= await foldersFun.deleteFolder()
    ...
    return <>
        <div className="favorite-frame p-20 p-b-2 ">
            <div className="select-part p-16 flex" style={{ justifyContent: 'space-between' }}>
                ...
                <Modal title="删除" open={isModalOpenThree} footer={null} width={400} >
                    <div className='m-t-20 m-l-80'>您确认<span className='text-color-red'>删除</span>该文件夹吗</div>
                    <Button className=' m-t-30 b-rd-8 m-r-16 m-l-200' type='primary' onClick={handleOkThree}>确认</Button>
