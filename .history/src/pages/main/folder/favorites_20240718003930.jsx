            ...
            <div className="list-frame p-16 flex-r-start-center " >
                {dataDeal.map((folder, index) => (
                    ...
                    >
                        ...
                        >
                            <IconFont type='icon-gengduo' onClick={()=>{ e.preventDefault(); // 阻止默认右键菜单
        e.stopPropagation();}} className='font-size-mlg position-absolute share-button' style={{ right: 15, top: 20 }}></IconFont>
                        </Popover>
