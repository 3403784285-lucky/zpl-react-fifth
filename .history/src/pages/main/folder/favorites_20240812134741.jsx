...
import { Dropdown, Popover, Popconfirm, Typography,List,Button, Input, Modal, message } from 'antd'
                    ...
                    renderItem={(operation) => (
                      <List.Item>
                        <List.Item.Meta
                          ...
                          description={
                            <Space>
                              {getIconByType(operation.documentType)}
                              <Text>{operation.documentName}</Text>
                            </Space>
                          }
                        />
                      </List.Item>
