...
function Recommendation() {
    return <div className="p-36" style={{ height: '80.5vh', overflowY: "auto" }}>
        ...
        <div className="flex" style={{ justifyContent: 'space-between' }}>
            <div className="one  b-rd-10" style={{ width: '32%', height: '120px', backgroundImage: "url('/img/rec-one.png')", backgroundSize: 'cover' }}>
                <div className="title">智能制造方案</div>
                <div className="desc">生产管理/缺料预警/供应链管理/质量管理/设备巡检</div>
            </div>
            <div className="one  b-rd-10" style={{ width: '32%', height: '120px', backgroundImage: "url('/img/rec-two.png')", backgroundSize: 'cover' }}>
                <div className="title">教务教学管理</div>
                <div className="desc">市场招生/学员管理/排课约课/成绩管理/采购管理</div>

            </div>
            <div className="one  b-rd-10" style={{ width: '32%', height: '120px', backgroundImage: "url('/img/rec-three.png')", backgroundSize: 'cover' }}>
                <div className="title">电商企业管理</div>
                <div className="desc">直播管理/供应与选品/进稍存订单管理</div>
            </div>
