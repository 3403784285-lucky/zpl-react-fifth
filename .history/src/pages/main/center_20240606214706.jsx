    ...
    return <div className="frame ">
        ...
        <div className="bottom flex-c-center-center">
            ...
            <div className="list p-20 ">
                <div className="pay-doc flex-c-center-center" style={{width:'300px',height:'270px',border:'blue solid 1px'}}>
                    <img src="/img/pay-doc.png" alt="" />
                    <div className="title font-bold font-size-base">付费文档会员专属折扣</div>
