...
function Center() {
    ...
    return <div className="frame " style={{ height: '75.5vh', overflowY: "auto" }}>
        ...
        <div className="bottom m-t-30 flex-c-center-center">
            ...
            <div className="card-frame flex m-t-20 m-b-20">
                ...
                >
                    ...
                    <div className="flex-r-center-center"> <IconFont type="icon-putongyonghu" className="m-r-20 font-size-vlg"></IconFont>普通用户</div>
                    <Divider />
                ...
                >
                    <div className="flex-c-center-center">
                        <div className="flex-r-center-center"><img src="/img/vip-header.png" className="img-sm m-r-20" alt="" />尊贵会员</div>
                        <Divider />
