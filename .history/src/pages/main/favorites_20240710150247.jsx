                ...
                {dataDeal.map((folder, index) => (
                    ...
                    >
                        ...
                        <div className="second-li">
                            <ul className='m-t-20 p-6 text-color-grey'>
                                {dataDeal[index].documents.map((item, index) => {
                                    return <li key={item.id} className='flex m-t-4 ' style={{ justifyContent: 'space-between' }}>
                                        <div style={{width:'100px'}} className='text-ellipsis'>{item.name}</div>
                                        <div style={{width:'100px'}} className='text-ellipsis'>{item.updateTime}</div>
                                    </li>
                                })}
                            </ul>
                        </div>
