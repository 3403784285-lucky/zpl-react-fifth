...
return <>
    <div className="favorite-frame p-20 p-b-2 ">
        ...
        <div className="list-frame p-16 flex position-relative" style={{ justifyContent: 'space-between' }}>
            <div className="li shadow b-rd-6 p-16 m-10 m-r-16" style={{ width: '250px', height: '180px' }}>
                ...
                <IconFont className='font-size-vlg m-r-10' type="icon-wenjianjia" />读书笔记</div>
                <IconFont type='icon-gengduo' className='font-size-mlg position-absolute' style={{right:0}}></IconFont>
