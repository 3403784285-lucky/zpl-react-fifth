function Center()
{
    return <div className="frame ">     
       <div className="flex-r-start-center p-20" style={{justifyContent:'space-between',backgroundImage:"url('/img/module-back.png')",height:'400px'}}>
        ...
        <div className="frame mosh shadow m-r-20" style={{width:'400px',height:'230px'}}>
