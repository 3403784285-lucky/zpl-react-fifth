...
return <>
    <div className="favorite-frame p-20 p-b-2 ">
        ...
        <div className="list-frame p-16 flex " style={{ justifyContent: 'space-between' }}>
            <div className="li shadow b-rd-6 p-16 m-10 m-r-16 position-relative hover-row-active" style={{ width: '250px', height: '180px' }}>
                <div className="first-header flex-r-start-center ">
                <IconFont className='font-size-vlg m-r-10' type="icon-wenjianjia" />读书笔记
                </div>
                <IconFont type='icon-gengduo' className='font-size-mlg position-absolute share-button' style={{right:15,top:15}}></IconFont>
