...
const OrderTable = () => {
    ...
    const handleOk = async (order, fun) => {
    ...
    const cancelView = (order) => {
        Modal.confirm({
            ...
            okText: '确认',
            cancelText: '取消',
            onOk: () => handleOk(order, orderFun.cancelOrder)
        });
    }
    ...
    const handleDelete = (order) => {
        Modal.confirm({
            ...
            okText: '确认',
            cancelText: '取消',
            onOk: () => handleOk(order, orderFun.deleteOrder)
        });
    };
                ...
                {dataDeal && (
                    <div className="order-details">
                        ...
                        <div className="order-row">
                            ...
                            <div className="order-value">{current.orderStatus}</div>
                        </div>
                        <div className="order-row">
                            <div className="order-label">创建时间:</div>
                            <div className="order-value">{current.createTime}</div>
                        </div>
                        <div className="order-row">
