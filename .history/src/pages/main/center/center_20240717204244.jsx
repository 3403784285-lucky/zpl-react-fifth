...
function Center() {
    ...
    const [money,setMoney]=useState(storage.getItem("money"))
        ...
        <div className="flex-r-start-center" style={{ justifyContent: 'space-between', backgroundImage: "url('/img/module-back.png')", height: '400px' }}>
            ...
            <div className="frame mosh shadow m-r-50 p-10 text-color-second flex-c-center-center" style={{ width: '400px', height: '230px' }}>
                ...
                <div className="two flex" style={{ justifyContent: 'space-between' }}>
                    <div className="number-one  m-x-20" onClick={()=>{storage.setItem("isBuying",true);navigate('/my-wallet') ;}}>
                ...
                <div className="three"><Button className="b-rd-4 font-bold" onClick={()=>{storage.setItem("isBuying",true);navigate('/my-wallet') ;}} style={{ width: '300px' }} size="large" type="primary">限时29.9开通VIP</Button></div>
