...
const OrderTable = () => {
    ...
    return (
        ...
        <div className='flex' style={{ justifyContent: 'space-between' }}>
            ...
            <Table columns={columns} rowKey={(record) => record.id} rowSelection={rowSelectionChon} loading={isLoading} dataSource={currentData}  pagination={false} rowClassName="hover-row className='position-relative'"
