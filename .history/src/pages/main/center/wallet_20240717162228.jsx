...
const pointsDataMember = [
    ...
    { id: 6, addPoints: 12, total: 1699, description: '购买12个月会员', productType: 'BUY_MEMBER' },
...
const Wallet = () => {
    ...
    useEffect(() => {
        // const member=storage.getItem("member")
        // setIsMember(member);
        ...
        <div style={{ height: '80.5vh', overflowY: 'auto' }}>
            <Spin spinning={loading}>
                <Card style={{ minWidth: 360 }}>
                    <ProCard type={"inner"} headerBordered bordered tooltip={"用于平台AI问答"} title={isMember?<Tag>尊享会员</Tag>:<strong>我的钱包</strong>}>
                        <strong>积分 : </strong><span style={{ color: "red", fontSize: 18 }}>{isMember?'2024-5-24过期':'38'}</span>
                    </ProCard>
                    <br />
