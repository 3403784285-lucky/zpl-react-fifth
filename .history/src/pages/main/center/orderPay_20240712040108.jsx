...
const OrderPay = () => {
    ...
    const proceedToPayment = () => {
        ...
        window.open(`http://rpwija.natappfree.cc/alipay/pay?orderName=${order.description}&orderId=${order.id}&totalPrice=${orderData.value.totalPrice}&orderType=${orderType}`);
      };
  return (
    <PageContainer>
      <Card>
