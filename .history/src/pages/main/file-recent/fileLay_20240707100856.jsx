...
import { Radio, Dropdown, Typography, Space, Button, Divider,Popover } from 'antd';
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <span>
                    {text}
                    <Button type='primary' className='position-absolute share-button b-rd-6' onClick={shareFun} style={{ right: 45, bottom: 10 }}>共享</Button>
                    <Popover
                        trigger="click"
                        open={open}
                        content={content}
                    ...
                    >
                     <IconFont type="icon-gengduo" onClick="" className='font-size-mlg position-absolute share-button' style={{ right: 15, bottom: 14 }}></IconFont>   
                    </Popover>
        ...
        <div className="start-frame p-x-30 p-y-10" >
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="删除" open={isModalOpenThree}  icon: <ExclamationCircleFilled />, footer={null} onOk={handleOkThree} onCancel={handleCancelThree} width={400} >
                       <div className='m-t-20 m-l-100'>您确认<span className='text-color-red'>删除</span>本条记录吗</div>
                        <Button className=' m-t-30 b-rd-8 m-r-30 m-l-100'  type='primary'>确认</Button>
                        <Button className=' m-t-30 b-rd-8 bg-color-grey text-color-white'>取消</Button>
