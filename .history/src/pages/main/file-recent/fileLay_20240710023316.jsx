            ...
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="新建" visible={isModalOpen} footer={null} onOk={handleOk} onCancel={handleCancel} width={300}>
                        <div className="flex">
                            <div className="model m-r-10 p-x-10 p-y-6 b-rd-6" style={{backgroundColor:selectedOption=='文档'?'lightblue':'white'}} onClick={() => handleOptionClick('文档')}>
                                <IconFont className='font-size-vlg ' type="icon-wendang" />
                                <p>文档</p>
                            </div>
                            <div className="model m-r-20 p-x-10 p-y-6 b-rd-6" style={{backgroundColor:selectedOption=='模板'?'lightblue':'white'}} onClick={() => handleOptionClick('模板')}>
