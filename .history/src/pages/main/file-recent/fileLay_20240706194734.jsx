...
const IconFont = createFromIconfontCN({
    scriptUrl: [
        '//at.alicdn.com/t/c/font_4248113_xz5vqyxjwgl.js'
    ],
});
function FileLay() {
    ...
    useEffect(() => {
        ...
        const deal = [
            ...
            {
                "name": `${data[0].document.name} {<IconFont className='m-l-20' type="icon-xinzengwenjianjia" />}`,
    ...
    return <>
        ...
        <div className="start-frame p-x-30 p-y-10" >
            ...
            <div className="bottom-frame">
                ...
                <Table columns={columns} rowSelection={rowSelection} dataSource={dataDeal} onChange={onChange} pagination={false} />
