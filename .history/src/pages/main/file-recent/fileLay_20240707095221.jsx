...
function FileLay() {
    ...
    const content=(<div >
        <div onClick="" className='p-6 hover-effect b-rd-6' onClick={onClick}>删除记录</div>
        ...
        <div className="start-frame p-x-30 p-y-10" >
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="新建" open={isModalOpenThree} footer={null} onOk={handleOkThree} onCancel={handleCancelThree} width={400}>
