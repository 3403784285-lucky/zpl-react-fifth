...
function FileLay()
{
    ...
    <div className="upper-frame">
        ...
        <div className="lay-out flex">
            <div className="list-one b-rd-10 m-10 p-10" style={ {width:'20%',height:'70px',border:'#1661ab 1px solid',}}><IconFont className='font-size-lg' type="icon-xinzengwenjianjia" /></div>
