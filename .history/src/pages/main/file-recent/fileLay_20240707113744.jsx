    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <span>
                    {text}
                    <Button type='primary' className='position-absolute share-button b-rd-6' onClick={shareFun} style={{ right: 45, bottom: 17 }}>共享</Button>
                    <Popover
                        trigger="click"
                        open={open}
                        content={content}
                    ...
                    >
                     <IconFont type="icon-gengduo" onClick="" className='font-size-mlg position-absolute share-button' style={{ right: 15, bottom: 17 }}></IconFont>   
                    </Popover>
