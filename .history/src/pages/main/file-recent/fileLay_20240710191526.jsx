    ...
    return <>
        ...
        <div className="start-frame p-x-30 p-y-10" >
            ...
            <div className="bottom-frame">
                ...
                <Table columns={columns} rowKey="dataIndex"  rowSelection={rowSelection} dataSource={dataDeal} onChange={onChange} pagination={false} rowClassName="hover-row className='position-relative'"
