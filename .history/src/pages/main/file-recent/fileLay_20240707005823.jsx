...
function FileLay() {
    ...
    const [isModalOpenCpy, setIsModalOpenCopy] = useState(false);
        ...
        <div className="start-frame p-x-30 p-y-10" >
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="新建" open={isModalOpen} footer={null} onOk={handleOkCopy} onCancel={handleCancelCpoy} width={300}>
                        <div className="flex">
                    ...
                    <Modal title="新建" open={isModalOpenCopy} footer={null} onOk={handleOkCopy} onCancel={handleCancelCopy} width={300}>
                        <div className="flex">
