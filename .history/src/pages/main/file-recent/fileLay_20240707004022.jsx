    ...
    },
    {
        ...
        render: (text, record) => (
            <span className='position-relative'>
                {text}
                <Button type='primary' className='position-absolute share-button b-rd-6' style={{right:0}}>共享</Button>
    ...
    return <>
        ...
        <div className="start-frame p-x-30 p-y-10" >
            ...
            <div className="bottom-frame">
                ...
                <Table columns={columns} rowSelection={rowSelection} dataSource={dataDeal} onChange={onChange} pagination={false}  rowClassName="hover-row"
