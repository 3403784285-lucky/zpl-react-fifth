        ...
        <div className="start-frame p-x-30 p-y-10" >
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="删除" open={isModalOpenThree} footer={null} onOk={handleOkThree} onCancel={handleCancelThree} width={300}>
                       <div>您确认<span className='text-color-red'>删除</span>本条记录吗</div>
                        <Button className=' m-y-10 b-rd-8 m-r-10' type='primary'>确认</Button>
                        <Button className=' m-y-5 b-rd-8 bg-color-grey text-color-white'>取消</Button>
