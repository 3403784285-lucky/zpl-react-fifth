    ...
    return <>
        ...
        <div className="start-frame p-x-30 p-y-10" >
            ...
            <div className="bottom-frame">
                ...
                <Table columns={columns} dataSource={dataDeal} onChange={onChange} pagination={false} />
                <Pagination className='m-t-20 position-absolute' style={{bottom:40, left:300}} total={50} showSizeChanger showQuickJumper hideOnSinglePage={true} />
