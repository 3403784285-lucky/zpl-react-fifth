            ...
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="共享" open={isModalOpenCopy} footer={null} onOk={handleOkCopy} onCancel={handleCancelCopy} width={300}>
                        ...
                        <Divider />
                        <div className='flex' style={{justifyContent:'space-between'}}>
                            <div><IconFont type='icon-link-break' className='font-size-lg m-r-10'></IconFont>链接权限</div>
                        ...
                        <Divider />
                         ...
                         <h4>发送</h4>
                         <Divider />
                         <Button className='b-rd-16 bg-color-black text-color-white width-full'>导出为word文档</Button>
