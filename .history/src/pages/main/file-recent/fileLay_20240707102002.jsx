        ...
        <div className="start-frame p-x-30 p-y-10" >
            <div className="upper-frame p-t-20">
                ...
                <div className="lay-out flex m-16">
                    ...
                    <Modal title="删除" open={isModalOpenThree} styles={{header:{borderRadius:'10px',backgroundColor:'RED'}}}  footer={null} onOk={handleOkThree} onCancel={handleCancelThree} width={400} >
                       <div className='m-t-20 m-l-90'>您确认<span className='text-color-red'>删除</span>本条记录吗</div>
                        <Button className=' m-t-30 b-rd-8 m-r-30 m-l-194'  type='primary'>确认</Button>
