...
function Recommendation() {
    ...
    <div className="desc">生产管理/缺料预警/供应链管理/质量管理</div>
    </div>
    <div className="one  b-rd-10" style={{width:'32%',height:'120px',backgroundImage:"url('/img/rec-two.png')",backgroundSize:'cover'}}></div>
    <div className="one  b-rd-10" style={{width:'32%',height:'120px',backgroundImage:"url('/img/rec-three.png')",backgroundSize:'cover'}}></div>
