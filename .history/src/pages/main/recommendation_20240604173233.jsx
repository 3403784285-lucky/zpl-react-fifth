    ...
    return <div className="p-30" style={{ height: '622px', overflowY: "auto" }}>
        <div className="doc m-b-10">
            ...
            <div className="item-frame p-10 flex" style={{ justifyContent: 'space-between' }} >
                <div className="item b-rd-6 shadow-second p-10 m-10 flex-c-center-center" style={{ width: '18%', height: '250px' }}>
        ...
        <div className="video m-b-20">
            <div className="second-title font-size-lg font-bold text-color-rgb(251,108,177)">热门素材</div>
            ...
            <div className="item-frame p-10 flex" style={{ justifyContent: 'space-between' }} >
                <div className="item b-rd-6 shadow-third p-10 m-10 flex-c-center-center" style={{ width: '32%', height: '200px' }}>
