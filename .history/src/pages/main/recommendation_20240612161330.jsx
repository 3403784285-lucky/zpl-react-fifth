...
const IconFont = createFromIconfontCN({
    scriptUrl: [
        '//at.alicdn.com/t/c/font_4580104_jlsq9s0em6.js',
        '//at.alicdn.com/t/c/font_4580104_siqq3ebn7vk.js'
    ...
    return <div className="p-36" style={{ height: '80.5vh', overflowY: "auto" }}>
        ...
        <div className="doc m-b-10">
            ...
            <div className="item-frame p-10 flex" style={{ justifyContent: 'space-between' }} >
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '24%', height: '250px' }}>
                    <img className="m-b-10" src="https://wkimg.bdimg.com/img/eb13653…?new=1&w=500&p=1" alt="图片示例" style={{ width: '90%', height: '78%' }} />

                    <div className="title font-bold"><IconFont className='font-size-mlg' type='icon-wordIcon'></IconFont>&nbsp;&nbsp;设备巡检和维修</div>
                </div>
                
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '24%', height: '250px' }}>
                    <img className="m-b-10" src="https://wkimg.bdimg.com/img/eb13653…?new=1&w=500&p=1" alt="图片示例" style={{ width: '90%', height: '78%' }} />

                    <div className="title font-bold"><IconFont className='font-size-mlg' type='icon-pdf1'></IconFont>&nbsp;&nbsp;固定资产标签</div>
                </div>
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '24%', height: '250px' }}>
                    <img className="m-b-10" src="https://wkimg.bdimg.com/img/eb13653…?new=1&w=500&p=1" alt="图片示例" style={{ width: '90%', height: '78%' }} />

                    <div className="title font-bold"><IconFont className='font-size-mlg' type='icon-biaoge1'></IconFont>&nbsp;&nbsp;产品详细说明</div>
                </div>
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '24%', height: '250px' }}>
                    <img className="m-b-10" src="https://wkimg.bdimg.com/img/eb13653…?new=1&w=500&p=1" alt="图片示例" style={{ width: '90%', height: '78%' }} />

                    <div className="title font-bold"><IconFont className='font-size-mlg' type='icon-biaoge1'></IconFont>&nbsp;&nbsp;团队任务管理</div>
                </div>
        ...
        <div className="video m-b-20">
            ...
            <div className="item-frame p-10 flex" style={{ justifyContent: 'space-between' }} >
                ...
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '32%', height: '200px' }}>
                    <video src='/img/speech.mp4' className="text-content m-b-10" style={{
                        width: '90%', height: '76%',

                    }} />


                    <div className="title font-bold text-overflow-1" style={{ width: '50%' }}><Tag bordered={false} className='b-rd-6' color="geekblue">视频</Tag>搞笑女在线演讲 </div>
                    <div className="pres font-size-sm text-color-grey text-overflow-1">2024-12-10 23:12</div>
                </div>
            </div>
