...
const mindMap = new MindMap({
  el: document.getElementById('mindyMapContainer'),
  data: {
    "data": {
        "text": "根节点"
    },
  ...
  return <div className="flex h-full shadow-primary" ref={scrollContainerRef}>
    ...
    <div className="" style={{ height: '100%', width: '84%' }}><div id="mindMapContainer"></div><Tiptap editor={editor} saveTimeInit={saveTimeInit} provider={provider} content={contentCopy} /></div>
  </div>
}
