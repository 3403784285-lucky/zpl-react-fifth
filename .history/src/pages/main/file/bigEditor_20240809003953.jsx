...
function BigEditor() {
  ...
  return <div className="flex h-full shadow-primary" ref={scrollContainerRef}>
    ...
    <div className="" style={{ height: '100%', width: '84%' }}><div id="mindMapContainer" style={{width:100,height:200}}></div><Tiptap editor={editor} saveTimeInit={saveTimeInit} provider={provider} content={contentCopy} /></div>
  </div>
}
