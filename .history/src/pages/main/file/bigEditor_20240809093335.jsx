...
function BigEditor() {
  ...
  const editor = useEditor({
    extensions: [
      ...
      Export.configure({
        appId: '123456',
        token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJPbmxpbmUgSldUIEJ1aWxkZXIiLCJpYXQiOjE3MjMxNjcxNTgsImV4cCI6MTc1NDcwMzE1OCwiYXVkIjoid3d3LmV4YW1wbGUuY29tIiwic3ViIjoianJvY2tldEBleGFtcGxlLmNvbSIsIkd pdmVuTmFtZSI6IkpvaG5ueSIsIlN1cm5hbWUiOiJSb2NrZXQiLCJFbWFpbCI6Impyb2NrZXRAZXhhbXBsZS5jb20iLCJSb2xlIjpbIk1hbmFnZXIiLCJQcm9qZWN0IEFkbWluaXN0cmF0b3IiXX0.95UgQuUYaxuoJcc0ojwjQlfLp8XUB1v7_n08t9r0DbI',
      }),
      CharacterCount,
      FontFamily,
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      const mindMap = new MindMap({
        ...
        data: {
          text: '张培灵', // 节点的文本，可以是富文本，也就是html格式的，此时richText要设为true
