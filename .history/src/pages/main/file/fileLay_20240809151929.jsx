...
import { fileToBase64 } from '../../../utils/code';
...
function FileLay() {
    ...
    const handleImportFilePick = e => {
        ...
        const file = new File(['content'], 'example.docx', { type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' });
        console.log(file)        
        createDocument()
