...
function BigEditor() {
  ...
  const [room, setRoom] = useState(183)
  ...
  console.log("滚动元素对象",scrollContainerRef)


  return <div className="flex-r-end-start h-full shadow-primary">
    ...
    <div className="" style={{ height: '100%', width: '84%' }}><Tiptap editor={editor} content={contentCopy} ref={scrollContainerRef}/></div>
