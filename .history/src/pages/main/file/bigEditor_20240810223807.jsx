...
function BigEditor() {
  ...
  const handleFind = (text) => {
    // Implement search and highlight logic here
  };
  ...
  return <div className="flex h-full shadow-primary" ref={scrollContainerRef}>
    ...
    <div className="" style={{ height: '100%', width: '84%' }}><Tiptap editor={editor} setIsModalVisible={setIsModalVisible} saveTimeInit={saveTimeInit} provider={provider} content={contentCopy} /></div>
  </div>
}
