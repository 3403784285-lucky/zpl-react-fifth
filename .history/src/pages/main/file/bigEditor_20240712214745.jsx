...
function BigEditor() {
    ...
    return <div className="flex h-full shadow">
        <div className="shadow p-20" style={{ height: '100%', width: '20%' }}>
            <h3 className="m-y-10">目录</h3>
            <div className="p-y-10 flex-c-center-center">
                 <MemorizedToC editor={editor} items={items} />
            </div>
           
        </div>
        <div className="" style={{ height: '100%', width: '80%' }}><Tiptap editor={editor} /></div>
