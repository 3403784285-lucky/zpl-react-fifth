...
const receiveChild = (items,editor) => {
    setEditor(editor)
    setItems(items)
}
...
return <div className="flex h-full shadow">
    ...
    <div className="" style={{ height: '100%', width: '80%' }}><Tiptap user={user} changeValue={receiveChild} room={3} items={items} content={contentCopy} /></div>
