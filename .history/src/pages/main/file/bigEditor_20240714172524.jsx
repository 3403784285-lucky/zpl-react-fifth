...
const location=useLocation()
    ...
    return <div className="flex h-full shadow">
        <div className="shadow p-20" style={{ height: '100%', width: '20%' }} ref={scrollContainerRef}>
            ...
            <div className="p-10">
                <MemorizedToC editor={editorCopy} items={items} scrollContainerRef={scrollContainerRef} />
            </div>
        </div>
        <div className="" style={{ height: '100%', width: '80%' }}><Tiptap editor={editorCopy} user={user} room={3} ydoc={ydoc} content={contentCopy}/></div>
