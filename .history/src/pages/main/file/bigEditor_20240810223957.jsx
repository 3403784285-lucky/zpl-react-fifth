...
function BigEditor() {
  ...
  editor.commands.unsetHighlight(); // Clear previous highlights
  ...
  doc.descendants((node, pos) => {
    if (node.isText) {
      ...
      while ((match = regex.exec(node.text)) !== null) {
        ...
        decorations.push(
          editor.view.state.tr.addMark(from, to, editor.schema.marks.highlight.create())
        );
      }
    }
  });

  decorations.forEach(tr => editor.view.dispatch(tr));
  };
