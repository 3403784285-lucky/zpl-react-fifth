...
function BigEditor() {
  ...
  return <div className="flex h-full shadow-primary" ref={scrollContainerRef}>
    ...
    <FindReplace
      ...
      />
      <Tiptap editor={editor} setIsModalVisible={setIsModalVisible} saveContent={saveContent} saveContentCopy={saveContentCopy} saveTimeInit={saveTimeInit} provider={provider} content={contentCopy} /></div>
  </div>
}
