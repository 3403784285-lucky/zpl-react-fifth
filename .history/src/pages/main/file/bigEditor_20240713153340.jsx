...
function BigEditor() {
    const provider = useMemo(() => { 
        ...
        return new WebsocketProvider(`ws://http://wpin7a.natappfree.cc/ws/${room}`, 'tttt', ydoc) 
      }, [ydoc, room]);
    ...
    return <div className="flex h-full shadow">
        ...
        <div className="" style={{ height: '100%', width: '80%' }}><Tiptap editor={editor} user={generateRandomUsers()} room={3} ydoc={ydoc} /></div>
