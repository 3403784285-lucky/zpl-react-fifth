...
function BigEditor() {
  ...
  const provider = useMemo(() => {
    if (room !=0) {
      ...
      return new WebsocketProvider(`ws://192.168.50.41:8080/ws/${room}`, 'tttt', ydoc)
    }
    return null
  }, [room, ydoc])
  console.log(ydoc)
    ...
    extensions: [
     ...
     Collaboration.configure({
        ...
        CollaborationCursor.configure({
          provider: new WebsocketProvider(`ws://192.168.50.41:8080/ws/1`, 'tttt', ydoc), // 确保正确传递 provider
          user: {
