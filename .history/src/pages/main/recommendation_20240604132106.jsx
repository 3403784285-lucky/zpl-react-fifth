        ...
        <div className="video">
            ...
            <div className="item-frame p-10 flex" style={{ justifyContent: 'space-between' }} >
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '32%', height: '200px' }}>
                    ...
                    <div className="title font-bold text-overflow-1" style={{ width: '50%' }}><Tag  className='b-rd-6' color="geekblue">文本</Tag>区块链基本知识</div>
                    <div className="pres font-size-sm text-color-grey text-overflow-1">2024-12-10 23:12</div>
                </div>
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '32%', height: '200px' }}>
                    ...
                    <div className="title font-bold text-overflow-1" style={{ width: '50%' }}><Tag className='b-rd-6' color="yellow">图片</Tag>清新大自然</div>
                    <div className="pres font-size-sm text-color-grey text-overflow-1">2024-12-10 23:12</div>
                </div>
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '32%', height: '200px' }}>
                    <div className="text-content m-b-10" style={{
                    ...
                    <div className="title font-bold text-overflow-1" style={{ width: '50%' }}><Tag bordered={false} className='b-rd-6' color="geekblue">文本</Tag>入党申请书 </div>
                    <div className="pres font-size-sm text-color-grey text-overflow-1">2024-12-10 23:12</div>
                </div>
            </div>
