        ...
        <div className="flex-r-start-center" style={{ justifyContent: 'space-between', backgroundImage: "url('/img/module-back.png')", height: '400px' }}>
            ...
            <div className="frame mosh shadow m-r-50" style={{ width: '400px', height: '230px' }}>
                <div className="one flex">
                    <img src="https://ts3.cn.mm.bing.net/th?id=OIP-C.p7Zf-FLKq5eU0uessiffgwHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2" style={{ width: '40px', height: '40px', borderRadius: '50%' }} />

                    <div className="name">
                        <div className="main font-bold">穿花云烛展</div>
