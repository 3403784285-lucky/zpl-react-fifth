...
function File() {
    ...
    return <div className="h-full p-10" >
        ...
        <Table columns={columns} rowSelection={rowSelection} loading={isLoading} dataSource={currentData} onChange={onChange}  rowClassName="hover-row className='position-relative'"
