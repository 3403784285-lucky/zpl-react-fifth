...
function Recommendation() {
    return <div className="p-30" style={{ height: '622px', overflowY: "auto" }}>
        ...
        <div className="video">
            ...
            <div className="item-frame p-10 flex" style={{ justifyContent: 'space-between' }} >
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '30%', height: '200px' }}>
                ...
                <div className="item b-rd-6 shadow p-10 m-10 flex-c-center-center" style={{ width: '34%', height: '200px' }}>
                    <div className="text-content m-b-10" style={{
                        width: '90%', height: '76%',
                        overflow: 'hidden',
                        textOverflow: 'ellipsis',
