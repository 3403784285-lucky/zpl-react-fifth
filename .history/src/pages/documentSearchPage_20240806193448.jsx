...
const DocumentSearchPage = () => {
    ...
    return (
        <div style={{ padding: '10px' }} className='flex-c-center-center'>
            ...
            <div style={{ marginTop: '20px',height:'52vh',overflowY:' overlay' }}>
                <List
                                    ...
                                    >
                                        <div className="document-card-content">
                                            <div className="document-card-title">
                                                     <div className='text-ellipsis'>{article.name}</div>
                                                     <div className='flex-r-start-center m-y-6'>
                                                         <div className="document-card-category">{article.profession}</div>
                                                        <div className="document-card-subject">{article.subject}</div>
                                                
                                                     </div>
                                              
                                            </div>
                                            <p className='text-ellipsis-two'>{article.documentKey}</p>
                                        </div>
                                    </Card>
                                </Tooltip>
