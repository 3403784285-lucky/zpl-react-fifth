...
function ItsCenter() {
    ...
    return <div className='flex-c-center-center' style={{ height: '73.5vh', overflowY: "auto" }}>
        <Modal title={<div className='flex-r-center-center'><IconFont type='icon-wordIcon' className='font-size-vlg m-r-10'></IconFont><h4>教师花名册</h4></div>} open={isModalOpen} footer={null} onOk={handleOk} onCancel={handleCancel} width={1000}>
            <div className="flex">
