...
function ItsCenter() {
    ...
    return <div className='flex-c-center-center' style={{ height: '73.5vh', overflowY: "auto" }}>
        <Modal title={<><IconFont type='icon-wordIcon' className='font-size-vlg'></IconFont><h4></h4></>} open={isModalOpen} footer={null} onOk={handleOk} onCancel={handleCancel} width={1000}>
            <div className="flex">
