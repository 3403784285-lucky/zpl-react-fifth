...
function ItsCenter() {
    ...
    return <div className='flex-c-center-center' style={{ height: '73.5vh', overflowY: "auto" }}>
        <Modal title={<div className='flex-r-start-center'><div><IconFont type='icon-wordIcon' className='font-size-vlg m-r-10'></IconFont><div><h4>教师花名册</h4><div className='text-color-grey font-size-sm'>作者：金山文档</div></div></div><Button>复制链接</Button></div>} open={isModalOpen} footer={null} onOk={handleOk} onCancel={handleCancel} width={1000}>
