    ...
    <div className='flex-c-center-center p-10' style={{ height: '100%' ,overflowY:'auto'}}>
      {!showCards ? (
        ...
        <Space direction="vertical" size="large">
          <Card title="评审意见" style={{width:300,height:300,overflowY:'auto'}}>{reviewText}</Card>
          <Card title="改进建议" style={{width:300,height:300,overflowY:'auto'}}>{suggestionText}</Card>
        </Space>
      )}
    </div>
  );
