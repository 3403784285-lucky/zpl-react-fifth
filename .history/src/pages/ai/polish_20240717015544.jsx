        ...
        <Form layout="vertical"style={{ width: 300, margin: '0 auto', paddingTop: 20 }}>
          ...
          <Row gutter={16}>
            <Col span={9}>
              ...
              <Select defaultValue="Inter" onChange={value => setFontFamilyH1Value(value)}>
            ...
            <Col span={8}>
              <Form.Item label=" ">
              <Select defaultValue="16" onChange={value => setFontSizeH1Value(`${value}px`)}>
            ...
            <Col span={7}>
              <Form.Item label=" ">
                ...
                <Option value="1.5倍">1</Option>
                  <Option value="1.5倍">1.5</Option>
                  <Option value="2倍">2</Option>
                  <Option value="2倍">3</Option>
                  {/* Add more options as needed */}
                </Select>
              </Form.Item>
            </Col>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label={<h4>使用</h4>}>
                <Button className='w-full bg-color-black text-color-white' >应用</Button>
              </Form.Item>
             
            </Col>
            <Col span={12}>
              <Form.Item label=" ">
              <Button className='w-full'>重置</Button>
              </Form.Item>
            </Col>
          </Row>    
