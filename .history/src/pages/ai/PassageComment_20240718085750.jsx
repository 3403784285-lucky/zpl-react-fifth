    ...
    <div className='flex-c-center-center p-10' style={{ height: '100%' ,overflowY:'auto'}}>
      {!showCards ? (
        ...
        <Space direction="vertical" size="large">
          <Card title="评审意见" ><div style={{width:270,height:300,overflowY:'auto'}}>{reviewText}</div></Card>
          <Card title="改进建议" ><div style={{width:270,height:300,overflowY:'auto'}}>{suggestionText}</div></Card>
        </Space>
      )}
    </div>
  );
