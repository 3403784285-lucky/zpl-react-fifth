...
import aiFun from './path/to/aiFun'; // 根据实际路径修改
...
const Extraction = () => {
    ...
    const handleChange = async ({ fileList: newFileList }) => {
        ...
        if (newFileList.length > 0) {
            ...
            try {
                const response = await aiFun.ocr(formData);
    ...
    return (
        <div className='p-30'>
            ...
            <div className='flex-c-center-center'>
                <Card className='m-t-20 shadow' hoverable style={{ width: 370 }}>
