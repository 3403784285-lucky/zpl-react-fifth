...
function Style({handleApplyStyles,fontFamilyH1Value, setFontFamilyH1Value, fontFamilyH2Value, setFontFamilyH2Value, fontFamilyH3Value, setFontFamilyH3Value, fontFamilyH4Value, setFontFamilyH4Value, fontSizeH1Value, setFontSizeH1Value, fontSizeH2Value, setFontSizeH2Value, fontSizeH3Value, setFontSizeH3Value, fontSizeH4Value, setFontSizeH4Value, lineHeightH1Value, setLineHeightH1Value, lineHeightH2Value, setLineHeightH2Value, lineHeightH3Value, setLineHeightH3Value, lineHeightH4Value, setLineHeightH4Value }) {
    ...
    const handleCancel = () => {
        setFontFamilyH1Value(selectedStyle[0].fontFamily);
        setFontSizeH1Value(selectedStyle[0].fontSize);
        setLineHeightH1Value(selectedStyle[0].lineHeight);
    
        setFontFamilyH2Value(selectedStyle[1].fontFamily);
        setFontSizeH2Value(selectedStyle[1].fontSize);
        setLineHeightH2Value(selectedStyle[1].lineHeight);
    
        setFontFamilyH3Value(selectedStyle[2].fontFamily);
        setFontSizeH3Value(selectedStyle[2].fontSize);
        setLineHeightH3Value(selectedStyle[2].lineHeight);
    
        setFontFamilyH4Value(selectedStyle[3].fontFamily);
        setFontSizeH4Value(selectedStyle[3].fontSize);
        setLineHeightH4Value(selectedStyle[3].lineHeight);
