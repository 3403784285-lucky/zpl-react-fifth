...
function Generation(){
    ...
    <Input placeholder="input search text" className='p-10 m-r-10 m-t-20' style={{width:'400px'}} suffix={<KubernetesOutlined className='hover-example' style={{fontSize:'20px'}}/>}  />
