...
增加未来研究方向的具体性：在探讨未来研究方向时，可以提出更具体的研究目标、方法或预期成果。例如，针对模型体积优化问题，可以提出采用剪枝、量化等技术的具体实施方案；针对跨领域学习能力提升问题，可以探讨引入迁移学习、领域自适应等方法的可能性。`
  ...
  return (
    <div className='flex-c-center-center p-10' style={{ height: '100%' ,overflowY:'auto'}}>
      {!showCards ? (
        ...
        <Space direction="vertical" size="large">
          <Card title="评审意见" ><div style={{width:280,height:300,overflowY:'auto'}}>{reviewText}</div></Card>
