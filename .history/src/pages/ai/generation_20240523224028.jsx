...
function Generation(){
    ...
    <Input placeholder="输入需求开始创作" className='p-10 m-r-10 m-t-20' style={{width:'400px'}} suffix={<KubernetesOutlined className='hover-example' style={{fontSize:'20px'}}/>}  />
    
    <div className="bottom-frame m-t-20"><KeyOutlined style={{color:'blue'}}/> nbsp;试试这样问</div>
