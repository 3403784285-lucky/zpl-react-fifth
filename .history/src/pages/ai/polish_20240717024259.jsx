...
function Polishing({fontFamilyH1Value,setFontFamilyH1Value,fontFamilyH2Value,setFontFamilyH2Value,fontFamilyH3Value,setFontFamilyH3Value,fontFamilyH4Value,setFontFamilyH4Value,fontSizeH1Value,setFontSizeH1Value,fontSizeH2Value,setFontSizeH2Value,fontSizeH3Value,setFontSizeH3Value,fontSizeH4Value,setFontSizeH4Value,lineHeightH1Value,setLineHeightH1Value,lineHeightH2Value,setLineHeightH2Value,lineHeightH3Value,setLineHeightH3Value,lineHeightH4Value,setFontFamilyH4Value}) {

  const handleApplyStyles = () => {
    // Logic to apply styles to headings
    console.log();
  };

  const handleResetStyles = () => {
    // Logic to reset styles
    ...
    return (
      ...
      <Row gutter={16}>
        <Col span={9}>
          <Form.Item label="二级标题">
            <Select defaultValue={fontFamilyH2Value} onChange={value => setFontFamilyH1Value(value)}>
              <Option value="Inter">Inter</Option>
              <Option value="Comic Sans MS">Comic Sans MS</Option>
              <Option value="Comic Sans">Comic Sans</Option>
              <Option value="serif">serif</Option>
        ...
        <Col span={8}>
          <Form.Item label=" ">
            <Select defaultValue={fontSizeH2Value} onChange={value => setFontSizeH1Value(value)}>
              <Option value="12px">12</Option>
              <Option value="14px">14</Option>
              <Option value="16px">16</Option>
              <Option value="18px">18</Option>
        ...
        <Col span={7}>
          <Form.Item label=" ">
            <Select defaultValue={lineHeightH2Value} onChange={value => setLineHeightH1Value(value)}>
              <Option value="1">1</Option>
              <Option value="1.5">1.5</Option>
              <Option value="2">2</Option>
              <Option value="3">3</Option>
      ...
      <Row gutter={16}>
        <Col span={9}>
          <Form.Item label="三级标题">
            <Select defaultValue={fontFamilyH3Value} onChange={value => setFontFamilyH1Value(value)}>
              <Option value="Inter">Inter</Option>
              <Option value="Comic Sans MS">Comic Sans MS</Option>
              <Option value="Comic Sans">Comic Sans</Option>
              <Option value="serif">serif</Option>
        ...
        <Col span={8}>
          <Form.Item label=" ">
            <Select defaultValue={fontSizeH3Value} onChange={value => setFontSizeH1Value(value)}>
              <Option value="12px">12</Option>
              <Option value="14px">14</Option>
              <Option value="16px">16</Option>
              <Option value="18px">18</Option>
        ...
        <Col span={7}>
          <Form.Item label=" ">
            <Select defaultValue={lineHeightH3Value} onChange={value => setLineHeightH1Value(value)}>
              <Option value="1">1</Option>
              <Option value="1.5">1.5</Option>
              <Option value="2">2</Option>
              <Option value="3">3</Option>
      ...
      <Row gutter={16}>
        <Col span={9}>
          <Form.Item label="正文">
            <Select defaultValue={fontFamilyH4Value} onChange={value => setFontFamilyH1Value(value)}>
              <Option value="Inter">Inter</Option>
              <Option value="Comic Sans MS">Comic Sans MS</Option>
              <Option value="Comic Sans">Comic Sans</Option>
              <Option value="serif">serif</Option>
        ...
        <Col span={8}>
          <Form.Item label=" ">
            <Select defaultValue={fontSizeH4Value} onChange={value => setFontSizeH1Value(value)}>
              <Option value="12px">12</Option>
              <Option value="14px">14</Option>
              <Option value="16px">16</Option>
              <Option value="18px">18</Option>
        ...
        <Col span={7}>
          <Form.Item label=" ">
            <Select defaultValue={lineHeightH4Value} onChange={value => setLineHeightH1Value(value)}>
              <Option value="1">1</Option>
              <Option value="1.5">1.5</Option>
              <Option value="2">2</Option>
              <Option value="3">3</Option>
