                ...
                <div className='b-rd-4' style={{ border: 'black solid 0.1px' }}>
                    <div className={`upper-frame bg-color-blue flex-end-center p-x-10 b-rd-6`} style={{ height: '8%' }}>
                        ...
                        <Tooltip placement="bottom" title={"插入兄弟节点"} >
                            ...
                            <IconFont type="icon-clue"  className='m-4 p-10 b-rd-4 font-size-lg' onClick={insertNode}  style={{display:`activeNodes.length?'block':'none'`}}/>
                        </Tooltip>
                        <Tooltip placement="bottom" title={"插入子节点"} >

                            <IconFont type="icon-Vector-11" onClick={insertChildNode}  style={{display:`activeNodes.length?'block':'none'`}} className='m-4 p-10 b-rd-4 font-size-lg' />
                        </Tooltip>
                        <Tooltip placement="bottom" title={"删除节点"} >

                            <IconFont type="icon-shanchujiedian" onClick={insertNode}  style={{display:`activeNodes.length?'block':'none'`}} className='m-4 p-10 b-rd-4 font-size-lg' />
                        </Tooltip>
