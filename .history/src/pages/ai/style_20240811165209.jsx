    ...
    return <div className="flex-c-center-center m-20">
        ...
        <div className='m-t-20'>
            <List
                ...
                renderItem={(item) => (
                    <List.Item >
                        <Card className='flex-r-center-center' style={{width:120scrollSnapPointsX, height: 100 }} hoverable onClick={showModal}>
                            <div className='flex-c-center-center text-ellipsis' style={{ width: '100px', height: '100%' }}>{item.styleName}</div>
                        </Card>
                    </List.Item>
                )}
            />
