    ...
    return (
        <div className='flex-c-center-center m-t-10 p-10'>
            ...
            <Modal
                ...
                open={open}
            >
                <div className={`upper-frame bg-color-blue flex-end-center p-x-10 b-rd-6`} style={{ height: '8%',border:'black solid 0.1px'}}>
                ...
                <div ref={contentRef} id="mindMapContainer" style={{ border:'black solid 0.1px',borderBottom:'white solid 0.1px'}}></div>
            </Modal>
