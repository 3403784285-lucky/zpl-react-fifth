...
function Extraction() {
    ...
    return <div className='p-30'>
        ...
        <div className='flex-c-center-center'><div className="first-frame flex  m-b-30" style={{ justifyContent: 'space-between', height: '20px' }}>
            ...
            <div className="tip-correction m-t-20 m-b-0" ><strong>提取结果</strong>
