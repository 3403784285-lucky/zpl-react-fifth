...
const AdminLogGrid = () => {
    return (
        <div style={{ height: '30vh', overflowY: 'auto', overflowX: 'hidden', display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <Row style={{ flex: 1, width: '100%' }} gutter={[10, 10]}>
                <Col span={18} style={{ backgroundColor: '#f0f0f0', borderRadius: '4px', minHeight: '200px', boxSizing: 'border-box' }}>
                    <Upper_Left />
                </Col>
                <Col span={6} style={{ backgroundColor: '#f0f0f0', padding: '10px', borderRadius: '4px', minHeight: '200px', boxSizing: 'border-box' }}>
                    <Upper_Right logData={[{
                        id: 1,
                        pricingId: 101,
                        oldPrice: 100.0,
            ...
            <Row style={{ flex: 2, width: '100%' }} gutter={[10, 10]}>
                <Col span={18} style={{ backgroundColor: '#f0f0f0', padding: '5px', borderRadius: '4px', boxSizing: 'border-box', minHeight: '300px' }}>
                    <Down_Left data={{
                        "totalApiCount": 10,
                ...
                <Col span={6} style={{ backgroundColor: '#f0f0f0', padding: "5px", borderRadius: '4px', boxSizing: 'border-box', minHeight: '300px' }}>
                    <Row>
                        <Col span={24} style={{ marginBottom: '10px', backgroundColor: '#ffffff', padding: '10px', borderRadius: '4px', minHeight: '150px' }}>
                        ...
                        <Col span={24} style={{ backgroundColor: '#ffffff', padding: '10px', borderRadius: '4px', minHeight: '150px' }}>
