            ...
            <Row style={{ flex: 2 }} gutter={[10, 10]}>
                ...
                <Col span={6} style={{ backgroundColor: '#f0f0f0', padding: "5px", borderRadius: '4px' }}>
                    ...
                    <Row style={{ height: '100%' }}>
                        <Col span={8} style={{ marginBottom: '10px', backgroundColor: '#ffffff', padding: '10px', borderRadius: '4px' }}>
                            右上（占1/3）
                        </Col>

                        <Col span={16} style={{ backgroundColor: '#ffffff', padding: '10px', borderRadius: '4px' }}>
