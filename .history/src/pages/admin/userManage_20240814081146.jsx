...
import { Table, Button, Avatar, Pagination, Modal } from 'antd';
    ...
    },
    {
      ...
      {record.level === 1 && (
        <Tag className='m-l-6 m-t-6' color="cyan">
          尊贵会员 {localStorage.getItem("user") && JSON.parse(localStorage.getItem("user")).level === 1 ? JSON.parse(localStorage.getItem("user")).memberExpireTime : ''}
        </Tag>
      )}
    },
    {
