...
const AdminLogGrid = () => {
    return (
        <div style={{ height: '83.5vh', overflowY: 'auto', overflowX: 'hidden', display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <Row style={{ flex: 1, width: '100%', overflow: 'hidden' }} gutter={[10, 10]}>
            ...
            <Row style={{ flex: 2, width: '100%', overflow: 'hidden' }} gutter={[10, 10]}>
                <Col span={18} style={{ backgroundColor: '#f0f0f0', padding: '5px', borderRadius: '4px', boxSizing: 'border-box' }}>
                    <Down_Left data={{
                        "totalApiCount": 10,
                ...
                <Col span={6} style={{ backgroundColor: '#f0f0f0', padding: "5px", borderRadius: '4px', boxSizing: 'border-box' }}>
                    <Row>
