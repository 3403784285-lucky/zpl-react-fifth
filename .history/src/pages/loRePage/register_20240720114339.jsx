...
const onFinish =async (values) => {
  ...
  const res=await userFun.register({})
          ...
          <div>
            ...
            >
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: 'Please input your Username!' }]}
              >
                <Input size='large' className='m-r-40' placeholder="请输入邀请码" style={{ width: 160 }} />
              ...
              <Form.Item>
                <Button type="primary" onClick={onFinish} htmlType="submit" className="login-form-button" size='large' style={{ width: 300 }}>
                  注册
                </Button>
              </Form.Item>
