        ...
        <div style={{ padding: '10px' }} className='flex-c-center-center'>
            ...
            <div style={{ marginTop: '10px' ,}}>
                ...
                {selectedMainCategory !== '全部' && (
                    ...
                    <Menu mode="horizontal" popupClassName="bg-color-red" selectedKeys={[selectedSubCategory]} items={subMenuItems} onClick={handleSubCategoryClick} style={{ marginTop: '10px' }} />
            ...
            <div style={{ marginTop: '20px',height:'46vh',overflowY:'auto',overflowX:'hidden' }}>
                <List
