...
const PersonalCenter = () => {
    ...
    const handleNicknameChange = (e) => {
        ...
        const res = userFun.update(nickname, avatar)
        if (res.code == 200) {
            console.log("信息修改成功")
        }
    };
            ...
            getBase64(file).then((base64Data) => {
                ...
                fileFun.upload(formData)
                    .then((response) => {
                        ...
                        const res = userFun.update(nickname,uploadedUrl,id:storage.getItem("openid"))
                        if (res.code == 200) {
                    ...
                    // const res1 = userFun.getUser(storage.getItem("openid"))
