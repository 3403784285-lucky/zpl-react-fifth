...
function MyExample({ editor }) {
    ...
    return <Dropdown
        ...
        trigger={['contextMenu']}
    ><div className="item-frame flex-r-center-center p-10" style={{ justifyContent: 'space-between',height:'84vh',overflowY:'auto' }} >
            {contextHolder}
            {loading1 ? <Skeleton /> : data.map((item, index) => (
                ...
                >  <Card
                    ...
                    key={item.key}
                    className="item b-rd-6 m-4 flex-c-center-center shadow"
                    hoverable={true}
                    style={{
                        width: 300,
