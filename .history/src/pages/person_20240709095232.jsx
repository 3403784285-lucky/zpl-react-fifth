...
const PersonalCenter = () => {
    ...
    return <div className="frame " style={{ height: '80.5vh', overflowY: "auto" }}>
        <div className='position-relative' style={{ height: '250px', backgroundImage: "url('/img/person.png')", backgroundSize: 'cover' }}>
            <div className="float-card position-absolute flex-r-start-center p-20" style={{ left: 33, bottom: -96, width: '78vw' }}>
                <div> <img src="/img/test1.jpg" className='img-lg b-rd-80 shadow' alt="头像" />
                <div className='font-size-vlg m-l-20'>穿花云烛展</div></div>
