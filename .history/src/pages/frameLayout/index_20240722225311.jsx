    ...
    <Layout >
      <Header className='p-10' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'white' }} >
        ...
        <div className="after-part flex">
          ...
          content={<div >
            <div className='flex'> <HomeOutlined className='m-x-6'/><div className='hover-effect b-rd-6' >个人中心</div></div>
           
            <div className='flex'><CreditCardOutlined  className='m-x-6'/><div className='hover-effect b-rd-6'>我的订单</div></div>
