...
const itemTwosCopy = [
  ...
  getItem('doc-manage', <QuestionCircleFilled />, '文档管理')
]
const Index = () => {
    ...
    <Layout >
      <Header className='p-10' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'white' }} >
        ...
        <div className="after-part m-r-20 flex">
          ...
          >
            <img src={img ?? storage.getItem("user")?.avatar ?? ''} disabled={status=="user"} onClick={() => { navigate('/person') }} style={{ width: '35px', height: '35px', borderRadius: '50%' }} />
          </Popover>
        </div>
      </Header>
      <Layout>
