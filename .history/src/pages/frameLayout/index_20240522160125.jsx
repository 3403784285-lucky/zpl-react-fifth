    ...
    <Layout >
      ...
      <Layout>
        ...
        <Layout style={{ padding: '0 24px 24px' }}>
          ...
          >
            <Layout>
              <Sider theme='light' width={650} className="shadow-first" style={{ overflow: 'auto', height: '75vh',borderRadius:'20px' }} >
          ...
          >
            ...
            <Form.Item>
              ...
              <Content className='flex shadow-first b-rd-6'>
                <Menu


                  mode="inline"
                  items={itemThrees}
                  style={{ height: '100%', borderRight: 0, width: '70px' }}
                  selectedKeys={['1']}
                ...
                <div className="bg-color-white flex-1 "></div>
              </Content>
            </Layout>
