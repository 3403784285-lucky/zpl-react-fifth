    ...
    <Layout >
      <Header className='p-10' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'white' }} >
        <div className="pre-frame flex-r-start-center"> 
          <IconFont type='icon-jihebiaoshi21' className='font-size-vlg m-r-10'></IconFont>

        <img src="/img/logo.png" style={{ width: '75px', height: '28px' }} />
        <Search className='m-l-50' placeholder="请输入关键字" style={{width:'300px'}} onSearch={onSearch} enterButton />
        </div>
