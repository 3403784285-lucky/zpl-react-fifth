...
import {AppstoreFilled,BellOutlined,EnvironmentFilled}  from '@ant-design/icons';
      ...
      <Layout>
        <Sider theme='light' width={200} style={{ background: colorBgContainer }}>
          ...
          >
            ...
            <Menu.Item><BellOutlined/>&nbsp;我的收藏</Menu.Item>
            <Menu.Item><BellOutlined/>&nbsp;我的文件夹</Menu.Item>
            <Menu.Item><BellOutlined/>&nbsp;素材库</Menu.Item>
            </Menu.ItemGroup>
