...
import {AppstoreFilled,BellOutlined,EnvironmentFilled,ExceptionOutlined,FolderAddOutlined,QuestionCircleFilled,CodeSandboxOutlined}  from '@ant-design/icons';
...
const itemTwos = [
  getItem('7',<AppstoreFilled/>,'会员中心'),
  getItem('8',<CodeSandboxOutlined/>,'会员工具'),
  getItem('9s',<AppstoreFilled/>,'会员福利')
