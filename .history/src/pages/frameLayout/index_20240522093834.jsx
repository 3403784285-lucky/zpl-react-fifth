...
const Index = () => {
  ...
  const [floatBottom,setFloatBottom]=useState(356);
  ...
  return (
    <Layout >
      ...
      <Layout>
        ...
        <FloatButton icon={<ArrowLeftOutlined/>} className='hover-button'  style={{ left: floatLeft,bottom:floatBottom }} onClick={() =>{setCollapsed(!collapsed);} }/>
