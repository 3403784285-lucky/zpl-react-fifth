...
import { Tooltip, Layout, Menu, theme, Input } from 'antd';
    ...
    <Layout >
      <Header className='p-10' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'white' }} >
        ...
        <div className="after-part flex">
          <Button className=' bg-color-second text-color-white b-rd-10 m-r-20' onClick={() => navigate("/member-center")}>会员中心</Button>
          <Tooltip placement="bottom"  color='white' title={<div>
