    ...
    <Layout >
      <Header className='p-10' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'white' }} >
        ...
        <div className="after-part flex">
          ...
          content={<div >
            <HomeOutlined /><div className='p-6 hover-effect b-rd-6' >个人中心</div>
            <CreditCardOutlined /><div className='p-6 hover-effect b-rd-6'>我的订单</div>
          </div>}>
