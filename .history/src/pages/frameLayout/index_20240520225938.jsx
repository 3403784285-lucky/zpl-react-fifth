...
import {AppstoreFilled,BellOutlined,EnvironmentFilled,ExceptionOutlined,FolderAddOutlined}  from '@ant-design/icons';
      ...
      <Layout>
        <Sider theme='light' width={200} style={{ background: colorBgContainer }}>
          ...
          >
            ...
            <Menu.Item><ExceptionOutlined/>&nbsp;素材库回收站</Menu.Item>
            </Menu.ItemGroup>
