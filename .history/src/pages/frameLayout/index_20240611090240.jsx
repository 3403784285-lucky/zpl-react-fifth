...
const IconFont = createFromIconfontCN({
  scriptUrl: [
    ...
    '//at.alicdn.com/t/c/font_4580104_904rpzvmqxr.js', // icon-shoppingcart, icon-python
  ],
});
...
const itemTwos = [
  ...
  getItem('library',<FolderAddOutlined />, '素材中心'),
...
const Index = () => {
  ...
  return (
    <Layout >
      ...
      <Layout>
        <Sider theme='light' className='container' width={200} style={{ overflow: 'auto', height: '90.5vh', position: 'relative' }} collapsed={collapsed}  >
