...
function MyExample({ editor }) {
    ...
    const handleSelect = (e) => {
        unique=modal.confirm({
            title: '上传素材',
            icon: <IconFont type='icon-jihebiaoshi21'></IconFont>,
            content: <div closeModal={closeModal} className='flex-c-center-center'><UploadMaterialForm /></div>,
            footer: null,
            closable: true
    ...
    return <Dropdown
        ...
        trigger={['contextMenu']}
    ><div className="item-frame flex-c-center-center p-10" style={{ justifyContent: 'space-between',height:'84vh',overflowY:'auto' }} >
            {contextHolder}
