        ...
        <div style={{ padding: '10px' }} className='flex-c-center-center'>
            ...
            <div style={{ marginTop: '10px' ,}}>
                ...
                {selectedMainCategory !== '全部' && (
                    ...
                    <Menu mode="horizontal" popupClassName={{height:100}} selectedKeys={[selectedSubCategory]} items={subMenuItems} onClick={handleSubCategoryClick} style={{ marginTop: '10px' }} />
